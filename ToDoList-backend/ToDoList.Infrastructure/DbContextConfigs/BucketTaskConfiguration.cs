...
public class BucketTaskConfiguration : IEntityTypeConfiguration<BucketTasks>
{
    ...
    {
        builder.HasData(
            new BucketTasks { Id = 1, BucketsId = 1, Name = "Speak to manager", BucketTaskPriorityId = 1, BucketTaskStateId = 1 },
            ...
            new BucketTasks { Id = 6, BucketsId = 3, Name = "Update training plan", BucketTaskPriorityId = 3, BucketTaskStateId = 2 }
        );
    }
}