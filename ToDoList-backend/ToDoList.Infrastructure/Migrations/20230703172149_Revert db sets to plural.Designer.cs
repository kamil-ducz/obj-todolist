...
namespace ToDoList.Infrastructure.Migrations
{
    ...
    [Migration("20230703172149_Revert db sets to plural")]
    partial class Revertdbsetstoplural
    {
            ...
            modelBuilder.Entity("ToDoList.Domain.Models.BucketTask", b =>
                {
                    ...
                    b.Property<int?>("BucketTaskStateId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ToDoList.Domain.Models.BucketTask", b =>
                {
                    ...
                    b.HasOne("ToDoList.Domain.Models.BucketTaskState", "BucketTaskState")
                        .WithMany()
                        .HasForeignKey("BucketTaskStateId1");
